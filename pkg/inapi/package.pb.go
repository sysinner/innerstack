...
type PackageSpecBuild struct {
	...
	// Patterns use Go filepath.Match semantics: *, ?, [...] within a single
	// path component (no recursive **). To include a directory tree, list the
	// directory itself. If empty, all files are included by default.
	// Examples: ["src", "lib", "config/*.toml"]
	Include []string `protobuf:"bytes,1,rep,name=include,proto3" json:"include,omitempty" toml:"include,omitempty"`
	// script is the build script to execute (optional). Run via "sh" with the
	// package source directory as the working directory. Two substitution
	// mechanisms are available, in addition to any vars from the env field:
	//
	//	${ipk_*} literal: ${ipk_dir}, ${ipk_build_dir}, ${ipk_name},
	//	  ${ipk_version}, ${ipk_release_version}, ${ipk_release_os},
	//	  ${ipk_release_arch}, ${ipk_prefix}   (${ipk_prefix} = /opt/<name>)
	//	$IPK_* shell env: IPK_DIR, IPK_BUILD_DIR, IPK_NAME, IPK_VERSION,
	//	  IPK_RELEASE_VERSION, IPK_RELEASE_OS, IPK_RELEASE_ARCH, IPK_PREFIX
...
var file_package_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x22, 0xb0, 0x02, 0x0a, 0x10, 0x50, 0x61, 0x63, 0x6b, 0x61,
	...
	,
	...
	0x7a, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x65, 0x64, 0x5f, 0x63,
	0x68, 0x75, 0x6e, 0x6b, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x03, 0x52, 0x0e, 0x75, 0x70, 0x6c,
	0x6f, 0x61, 0x64, 0x65, 0x64, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x63,
	...
	,
